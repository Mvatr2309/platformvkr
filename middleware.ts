...
// «Платформа ВКР» ему закрыта (08.02). Уведомления трубы живут на
// /expert/notifications внутри её route-группы, поэтому платформенные
// /notifications внешнему эксперту больше не нужны (08.22).
// Обращения оставляем: это канал поддержки, а не раздел платформы.
const expertAllowedPaths = ["/spaces", "/expert", "/inquiries"];
